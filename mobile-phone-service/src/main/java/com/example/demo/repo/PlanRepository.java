...
public interface PlanRepository extends JpaRepository<MobilePlan, Integer> {
	...
	@Query(value = "select * from lumen_mobile_plans where cost>:srchAmount",nativeQuery = true)//native query
	...
	@Modifying
	@Transactional
	int updateValidity(@Param("newValue") String updatedValidity,@Param("pname") String validityplanName);
